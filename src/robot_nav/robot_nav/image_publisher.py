...
"""
图像发布节点
- 订阅 Webots 相机原始话题 /webots/camera
- 将图像格式转换为标准 sensor_msgs/Image
- 以 30Hz 频率发布到 /camera/image 话题
- 同时转发相机内参到 /camera/camera_info
"""
...
class ImagePublisherNode(Node):
    def __init__(self):
        ...
        # 声明参数：Webots 原始话题名可在 launch 中覆盖
        self.declare_parameter('input_image_topic', '/webots/camera')
        ...
        self.info_sub = self.create_subscription(
            CameraInfo, input_topic + '_info', self.info_callback, 10
        )
